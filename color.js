...
// Solution 3.
   employees = [
    ...
    // Return a new array with those employees that are web developers
    ...
    console.log("Web Developers in Nigeria: ", employees.filter(employee => employee.Job === 'Web Developer' && employee.Country === 'Nigeria'))
    
    // Return a new array with those employees below 20
    console.log("Employees below 20 years: ", employees.filter(employee => employee.age < 20));
